...
export const getFilamentos = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .send({ message: "Erro ao buscar filamentos", error: error.message });
    }
}
...
export const getFilamentoById = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .send({ message: "Erro ao buscar filamento", error: error.message });
    }
}
...
export const addFilamento = async (req, res) => {
    try {
        ...
        return res
            .status(201)
            .send({ message: "Filamento criado com sucesso", filamento });
    } catch (error) {
        return res
            .status(500)
            .send({ message: "Erro ao criar filamento", error: error.message });
    }
}
...
export const updateFilamento = async (req, res) => {
    try {
        ...
        return res
            .status(200)
            .send({ message: "Filamento atualizado com sucesso", updatedFilamento });
    } catch (error) {
        return res
            .status(500)
            .send({ message: "Erro ao atualizar filamento", error: error.message });
    }
}
...
export const deleteFilamento = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .send({ message: "Erro ao deletar filamento", error: error.message });
    }
}