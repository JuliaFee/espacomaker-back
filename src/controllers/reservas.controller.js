...
export const addReserva = async (req, res) => {
    try {
        ...
        const createdReserva = await reservasRepository.addReserva(newReserva);
        return res.status(201).send({ message: "Reserva criada com sucesso", reserva: createdReserva });
    } catch (error) {
