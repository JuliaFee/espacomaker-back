...
export const addImpressora = async (req, res) => {
  try {
    ...
    // Converte 'statusI' para booleano
    const booleanStatusI = statusI === 'disponivel'; // 'disponivel' como true, outros valores como false

    // Criar impressora com status booleano
    const newImpressora = new Impressora(nome, descricao, img, booleanStatusI);
...
export const updateImpressora = async (req, res) => {
  try {
    ...
    // Converte 'statusI' para booleano
    const booleanStatusI = statusI === 'disponivel';

    // Atualizar impressora no banco com status booleano
    const updatedImpressora = await impressoraRepository.updateImpressora(id, nome, descricao, img, booleanStatusI, filamento);
